...
class GroupePolicy
{
    ...
    {
        return $this->checkAbilityByAction($user, 'Afficher groupe');
    }
    ...
    {
        return $this->checkAbilityByAction($user, 'ajouter groupe');
    }
    ...
    {
        return $this->checkAbilityByAction($user, 'modifier groupe');
    }
    ...
    {
        return $this->checkAbilityByAction($user, 'supprimer groupe');
    }
