...
class PartenairePolicy
{
    ...
    {
        return $this->checkAbilityByAction($user, 'afficher partenaire');
    }
    ...
    {
        return $this->checkAbilityByAction($user, 'ajouter partenaire');
    }
    ...
    {
        return $this->checkAbilityByAction($user, 'modifier partenaire');
    }
    ...
    {
        return $this->checkAbilityByAction($user, 'supprimer partenaire');
    }
