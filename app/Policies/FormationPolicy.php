...
class FormationPolicy
{
    ...
    {
        return $this->checkAbilityByAction($user, 'afficher formation');
    }
    ...
    {
        return $this->checkAbilityByAction($user, 'ajouter formation');
    }
    ...
    {
        return $this->checkAbilityByAction($user, 'modifier formation');
    }
    ...
    {
        return $this->checkAbilityByAction($user, 'supprimer formation');
    }
