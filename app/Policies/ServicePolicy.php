...
class ServicePolicy
{
    ...
    {
        return $this->checkAbilityByAction($user, 'afficher service');
    }
    ...
    {
        return $this->checkAbilityByAction($user, 'ajouter service');
    }
    ...
    {
        return $this->checkAbilityByAction($user, 'modifier service');
    }
    ...
    {
        return $this->checkAbilityByAction($user, 'supprimer service');
    }
