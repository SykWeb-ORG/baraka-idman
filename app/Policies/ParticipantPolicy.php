...
class ParticipantPolicy
{
    ...
    {
        return $this->checkAbilityByAction($user, 'afficher participant');
    }
    ...
    {
        return $this->checkAbilityByAction($user, 'ajouter participant');
    }
    ...
    {
        return $this->checkAbilityByAction($user, 'modifier participant');
    }
    ...
    {
        return $this->checkAbilityByAction($user, 'supprimer participant');
    }
