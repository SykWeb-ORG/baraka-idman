...
(() => {
/*!***************************************************************!*\
  !*** ./resources/js/intervenant/violenceType-beneficiaire.js ***!
  \***************************************************************/
...
function displayAllViolenceTypes(violence_types) {
  var tbodyViolenceTypes = document.getElementById('tbodyViolenceTypes');
  violence_types.forEach(function (violenceType) {
    var violenceType_input = document.createElement('input');
    ...
    var tdViolenceTypeInp = document.createElement('td');
    tdViolenceTypeInp.appendChild(violenceType_input);
    var tdViolenceTypeLabel = document.createElement('td');
...
function checkViolenceTypesByBeneficiaire(beneficiaire) {
  console.log(beneficiaire);
  beneficiaire.violence_types.forEach(function (violence_type) {
...
$(document).ready(function () {
  ...
  var btnMatchViolenceTypes = document.getElementById('btnMatchViolenceTypes');
  btnMatchViolenceTypes.addEventListener('click', function (e) {
    debugger;
    var selectedViolenceTypes = jQuery.grep($('input[name="violence_types[]"]'), function (violenceType) {
      return violenceType.checked;
    });
    if (beneficiaire) {
      var violenceTypesIds = jQuery.map(selectedViolenceTypes, function (violenceType) {
        return violenceType.value;
      });
      var endUrl = 'match-beneficiaire-violence_types/' + beneficiaire.id;
      // $.ajax({
      //     type: "POST",
      //     url: baseUrl + endUrl,
      //     async: false,
