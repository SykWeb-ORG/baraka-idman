...
(() => {
/*!*************************************************************!*\
  !*** ./resources/js/intervenant/couverture-beneficiaire.js ***!
  \*************************************************************/
...
function displayAllCouvertures(couvertures) {
  var divPermissions = document.getElementById('couv-medic');
  couvertures.forEach(function (couverture) {
    var couverture_input = document.createElement('input');
    ...
    var couverture_label = document.createElement('label');
...
function checkCouverturesByBeneficiaire(beneficiaire) {
  beneficiaire.couvertures.forEach(function (couverture) {
    var couverture_input = document.getElementById(couverture.id);
...
$(document).ready(function () {
  ...
  var btnMatchCouvertures = document.getElementById('btnMatchCouvertures');
  btnMatchCouvertures.addEventListener('click', function (e) {
    debugger;
    var selectedCouvertures = jQuery.grep($('input[name="couvertures[]"]'), function (couverture) {
      return couverture.checked;
    });
    if (selectedCouvertures.length > 0 && beneficiaire) {
      var couverturesIds = jQuery.map(selectedCouvertures, function (couverture) {
        return couverture.id;
      });
      var endUrl = 'match-beneficiaire-couvertures/' + beneficiaire.id;
      // $.ajax({
      //     type: "POST",
      //     url: baseUrl + endUrl,
      //     async: false,
