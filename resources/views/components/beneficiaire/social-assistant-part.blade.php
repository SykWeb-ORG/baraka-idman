...
<div class="mb-3 d-flex justify-content-center">
    ...
    data-bs-target="#modal_AffectCasJuridique"><i class="fas fa-balance-scale me-2"></i>Affecter Cas Juridique</button>
</div>
<!-- Modal -->
...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">Affect Cas Juridique</h5>
