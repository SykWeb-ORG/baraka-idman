        ...
        <div class="navbar-nav w-100">
            ...
            @canany(['create', 'viewAny'], App\Models\User::class)
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Utilisateurs</a>
            ...
            @canany(['create', 'viewAny'], App\Models\Beneficiaire::class)
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Bénéficiaires</a>
                    <div class="dropdown-menu bg-transparent border-0">
                        @can('create', App\Models\Beneficiaire::class)
                            <a href="{{ route('new-user-form') }}" class="dropdown-item">Ajouter</a>
                        @endcan
                        @can('viewAny', App\Models\Beneficiaire::class)
                            <a href="{{ route('list-beneficiaires') }}" class="dropdown-item">Afficher</a>
                        @endcan
                    </div>
                </div>
            @endcanany
