    ...
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            ...
            @can('roles-permissions-ability')
                <a href="{{ route('roles-permissions') }}" class="nav-item nav-link"><i class="fas fa-tasks me-2"></i>Gérer les rôles</a>
            @endcan
            <a href="{{ route('logout') }}" class="nav-item nav-link"><i class="fas fa-sign-out-alt me-2"></i>Quitter</a>
        </div>
    </nav>
</div>
<!-- Sidebar End -->